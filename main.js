...
document.addEventListener("DOMContentLoaded" , promoCode)
var Cupon = document.querySelector("#Cupon");
var apply = document.querySelector("#apply");
function promoCode() {
    Cupon.style.display = "none";
    apply.style.display = "none";

    document.querySelector("#Promocode").addEventListener("click" , Cupoon)

    function Cupoon() {
        Cupon.style.display = "";
        apply.style.display = "";
        document.querySelector("#Promocode").remove();
    }
...
var productt =document.querySelector("#product2");
function Removee() {
